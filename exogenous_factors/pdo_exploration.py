...
def plot_hot_cold_hist(new_df, port):
	...
	plt.title('Probability Distribution of Landings 4 years after Hot and Cold Seasons')
	plt.xlabel('Landings (millions of pounds)')
...
def plot_landings_vs_lagged(seasonal, port, pdo_annual, lag_years):
	...
	plt.title('Landings compared to Lagged PDO')
	plt.xlabel('Season')
